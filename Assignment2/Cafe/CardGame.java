...
public class CardGame extends Game // Game을 Base class로 한 CardGame class 입니다.
{
	public CardGame(String name, double price, int quality) // 상위 class의 constructor를 invoke 합니다.
	{
	...
	{
		return ("Name: " + super.getName() + ", Quality: " + getQuality() + ", Price: " + super.getPrice() + ", type: Card");
	}
}
